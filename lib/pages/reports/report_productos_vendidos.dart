...
class ReportProductosVendidos {
  ...
  Future<void> generarReporteProductosVendidos(
    ...
    try {
      ...
      // Modificar estas líneas para usar el ReportController
      final path = await reportController.generarPDF(
          pdf, "reporte_productos_vendidos.pdf");
      if (context.mounted) {
        await reportController.mostrarPDF(context, path);
      }
    } catch (e, stackTrace) {
